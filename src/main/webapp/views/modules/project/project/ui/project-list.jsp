    ...
    <div class="row" style="margin-top: 10px ">
        <div class="col s12 m6 l6">
            <div class="input-field">
                ...
                <input id="icon_prefix" type="text" ng-model="currentPage.query" ng-keyup="$event.keyCode == 13 && loadProjects()" >
                <label for="icon_prefix">Buscar por projetos</label>
            </div>
        </div>
        <div class="col s12 m6 l6 ">
            <div class="input-field right">
                <button class="waves-effect waves-light btn light-blue" ng-click="loadProjects()"><i class="mdi-content-filter-list left"></i><span class="hide-on-med-only">Filtrar</span></button>
