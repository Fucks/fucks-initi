    ...
    <div class="row" style="margin-top: 10px;margin-bottom: 8px;">
        <div class="col s12 m6 l6">
            <md-input-container class="md-icon-float md-block" style="margin-top: 0;">
                ...
                <label>Buscar por projetos</label>
        ...
        <div class="col s12 m6 l6 ">
            <div class="input-field right">
                <input id="file" type="file" ng-model="controller.mppfile" hidden="true"  onchange="angular.element(this).scope().controller.importProject(this)" >
                <button class="waves-effect waves-light btn light-blue" ng-click="controller.loadProjects()"><i class="mdi-content-filter-list left"></i><span class="hide-on-med-only">Filtrar</span></button>
                <button class="waves-effect waves-light btn light-blue" onclick="$('#file').trigger('click')"><i class="mdi-file-file-download left"></i><span class="hide-on-med-only">Importar</span></button>
            </div>
        </div>
    </div>
