...
<md-data-table-container>
    <table md-data-table md-row-select="controller.selected" md-progress="deferred" class="md-primary">
        <thead md-order="query.order" md-trigger="controller.onPaginationChange" orderBy="entity.firstName">
            <tr>
        ...
        <tbody>
            <tr ng-repeat="entity in controller.currentPage.content">
                ...
                <td><a class="btn-flat waves-effect" style="padding: 0 10px;" ng-click="controller.changeToEdit(entity.id)"><i class="material-icons">send</i></a></td>
            </tr>
        </tbody>
    </table>
</md-data-table-container>
