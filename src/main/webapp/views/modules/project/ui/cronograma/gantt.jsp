...
<div class="page-content">
    <div class="col s12 m12 l12">
        <div class="col s12">
                ...
                <div class="col s12 m6 l6 ">
                    <div class="input-field right">
                        <div class="input-field col s12">
                            <button class="waves-effect waves-light btn light-blue" ng-click="controller.showAdvanced($event)">
                                <i class="material-icons">account_box</i>
                                <md-tooltip>
                                    Alocar recursos
                                </md-tooltip>
                            </button>
                            <button class="waves-effect waves-light btn light-blue" ng-click="controller.viewResources()">
                                <i class="material-icons left">person_add</i>
                                <span class="hide-on-med-only">Add Recurso</span>
                                <md-tooltip>
                                    Adicionar recursos no projeto
                                </md-tooltip>
                            </button>
                            <button class="waves-effect waves-light btn green" ng-click="controller.saveGantt()">
                                <i class="material-icons left">save</i>
                                <span class="hide-on-med-only">Salvar</span>
                                <md-tooltip>
                                    Salvar projeto
                                </md-tooltip>
                            </button>
            ...
            <div id="resourcesContent" ng-hide="{{!controller.showResourceContent}}" layout="column" class="col s12 card-panel" ng-class="{
                'ng-hide'
                        : !controller.showResourceContent}">
                <md-toolbar class="resource-header">
                    <div class="md-toolbar-tools">
                        <h2 class="md-flex">Equipe do Projeto</h2>
                        <span flex></span>
                        <md-button class="md-icon-button" aria-label="Close" ng-click="controller.viewResources()">
                ...
                <div flex layout="row">
                    <div flex layout="column" style="overflow: auto;">
                        <md-content flex layout-margin>
                            <md-list>
                                <md-list-item class="sm-3-line" ng-repeat="entity in controller.projectResources">
                                    <img class="face" src="resource/images/default_user.png">
                                    <div class="md-list-item-text">
                                        <h4>{{entity.name}}</h4>
                                        <p>{{entity.occupation}} - {{entity.profile}}</p>
                                    </div>
                                    <md-button class="md-icon-button md-secondary" aria-label="Close" ng-click="controller.removeResourceInProject(entity)">
                            ...
                            <form>
                                <div layout layout-sm="column">
                                    <md-input-container class="md-icon-float md-block" flex>
                                        <label>Usuário</label>
                                        <input ng-model="controller.resource.user">
                                ...
                                <div layout layout-sm="column">
                                    <md-input-container flex>
                                        <label>Cargo</label>
                                        <input ng-model="controller.resource.occupation">
                                    </md-input-container>
                                    <md-input-container flex>
                                        <label>Perfil</label>
                                        <input ng-model="controller.resource.profile">
                                    </md-input-container>
                                </div>
                                <div class="input-field col s12">
                                    <div class="section right">
                                        <div class="col s12">
                                            <button class="waves-effect waves-light btn light-blue" ng-click="controller.addResourceInProject(controller.resource)"><i class="material-icons left">save</i>Salvar</button>
                                            <button class="waves-effect waves-light btn" ng-click="controller.resource = {}"><i class="material-icons left">cancel</i>Limpar</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
            ...
            <div class="col s1" ng-hide="{{controller.showResourceContent}}" ng-class="{
                'ng-hide'
                        : controller.showResourceContent}">
                <div class="noprint">
            ...
            <div  id="workSpace" ng-hide="{{controller.showResourceContent}}"  
                  class="col s11 card-panel" 
                  ng-class="{
                      'ng-hide'
                              : controller.showResourceContent}" 
                  style="padding: 0">
    ...
    <div id="gantEditorTemplates" style="display:none;">
        ...
        <div class="__template__" type="TASKROW" style="display: none">
            <!--        <tr taskId="(#=obj.inprojectId#)" class="taskEditRow" level="(#=level#)">
                        <td class="edit" onclick="editTask($(this))" style="cursor:pointer;"><span class="taskRowIndex">(#=obj.getRow()+1#)</span></td>
                        ...
                        <td><input type="text" id="start(#=obj.getRow()+1#)" class="(#=obj.isParent()?'eap':''#) data" data-toggle="datepicker" name="start"></td>
                        <td><input type="text" id="end(#=obj.getRow()+1#)" class="(#=obj.isParent()?'eap':''#) data" data-toggle="datepicker" name="end"></td>
        ...
        <!--    Gambiarras necessárias-->
        <script type="text/javascript">
                    var editTask = function ($event) {
                        $event.scope().controller.editTask($event);
                    }
        </script>
